...
import com.example.vmntr.NormalChatActivity;
...
public class NormalUserAdapters extends RecyclerView.Adapter<NormalUserAdapters.NormalUserViewHolder> {
    Context context;
    ArrayList<Users> list;
    String time;
    public NormalUserAdapters(Context context, ArrayList<Users> list) {
    ...
    @NonNull
    @Override
    public NormalUserAdapters.NormalUserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.user_sample,parent,false);
        return new NormalUserAdapters.NormalUserViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NormalUserAdapters.NormalUserViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(context, NormalChatActivity.class);
